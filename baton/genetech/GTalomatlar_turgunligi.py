...
for class_label in set(target):
    ...
    ax.scatter(x_lar, y_lar, s=200, marker=marker[class_label], label=str(class_label))
...
fig.savefig(f"..\\out_data\\{tanlanma_nomi}\\fig3.pdf")
functions.start_file(f"..\\out_data\\{tanlanma_nomi}\\fig3.pdf")
